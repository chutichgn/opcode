...
fn create_default_commands() -> Vec<SlashCommand> {
    vec![
        ...
        SlashCommand {
            id: "default-kill".to_string(),
            name: "kill".to_string(),
            full_command: "/kill".to_string(),
            scope: "default".to_string(),
            namespace: None,
            file_path: "".to_string(),
            content: "Delete the current session and close the tab".to_string(),
            description: Some("Delete current session and close tab".to_string()),
            allowed_tools: vec![],
            has_bash_commands: false,
            has_file_references: false,
            accepts_arguments: false,
        ...
        SlashCommand {
            id: "default-session-kill".to_string(),
            name: "session_kill".to_string(),
            full_command: "/session_kill".to_string(),
            scope: "default".to_string(),
            namespace: None,
            file_path: "".to_string(),
            content: "Delete the current session and close the tab".to_string(),
